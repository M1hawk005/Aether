...
require (
	aether-daemon v0.0.0-00010101000000-000000000000
...
// replace github.com/wailsapp/wails/v2 v2.12.0 => C:\Users\adity\go\pkg\mod

replace aether-daemon => ../src/daemon-go
